    ...
    <section className="w-full py-12 md:py-24 mt-2 bg-[#060606] text-white">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col w-full lg:flex-row gap-4 items-center">
          <div className="flex flex-col justify-center lg:w-2/3 space-y-6 text-center lg:text-left">
            <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl leading-none">
              ...
              <br />
              <span className="text-red-primary w-full lg:leading-relaxed lg:text-7xl">
                Discover, Save, Slam.
              </span>
            </h1>
            <p className="max-w-[700px] mx-auto px-4 lg:mx-0 text-lg md:text-xl text-gray-300">
            ...
            <div className="flex flex-col items-center md:items-start  w-full sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
              
                asChild
                className="bg-red-500 text-white hover:bg-red-700 text-lg px-8 py-6 rounded-lg"
              >
                <Link href="#" aria-label="Get Started" >Get Started</Link>
              </Button>
              <Button
                asChild
                variant="outline"
